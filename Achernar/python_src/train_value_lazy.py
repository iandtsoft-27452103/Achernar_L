...
class train_value:
    def __init__(self):
        ...
        self.epoch = 1
        self.iteration = 0
        self.log_file_name = 'train_value_lazy.txt'
        self.model_file_name = 'model_value_lazy.pth'
        self.optimizer_file_name = 'optimizer_value_lazy.pth'
        self.scheduler_file_name = 'scheduler_value_lazy.pth'
        ...
        for epoch in range(self.epoch):
            ...
            while iteration < iteration_max:
                ...
                for i in range(loop_start, loop_end):
                    ...
                    #ラベルのリストに保存する
                    if color == 0:
                        if clsio.rec[record_no].result == clsre.black_win:
                            lbl = 1
                        else:
                            lbl = 0
                    else:
                ...
                #tcnt += t.size(0)
                train_acc = self.binary_accuracy(y, t)
                ...
                if console_out_counter == self.console_out_threshold:
                    console_out_counter = 0
                    print('epoch = [{}/{}], ith = [{}/{}], train_loss: {a:.10f}, train_accuracy: {b:.10f}'.format(epoch + 1, self.epoch, iteration, iteration_max, a=avg_train_loss, b=train_acc))
